        ...
        <>
            <div className="flex flex-col h-[93vh]">
                <div className="drawer drawer-mobile">
                    ...
                    <Fade direction="left">
                        <div className="drawer-side w-50 shadow-2xl bg-base-300 h-[90vh] overflow-y-scroll overflow-auto ">
                            <div className="">
                                <label htmlFor="my-drawer-2" className="drawer-overlay"></label>
                                <ul className="menu p-4 w-60 bg-base-300 text-base-content pb-20">
                                    <li>
