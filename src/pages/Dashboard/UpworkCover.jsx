...
const UpworkCover = () => {
  ...
  const handleSubmit = () => {
    ...
    Best regards,
    Biron Clark". All output shall be in  English"`
          ...
          <div className="">
            <div className="form-control w-full max-w-xs gap-2">
              <label className="label">
                <span className="label-text font-semibold">Upwork Cover Letter</span>
              </label>
              <textarea name="AI Response" placeholder="Describe the job you are writing this cover letter for..." className="border border-primary textarea w-full h-20 resize-none" cols="40" rows="1" onChange={(e) => setProduct(e.target.value)}></textarea>
              <label className="label">
