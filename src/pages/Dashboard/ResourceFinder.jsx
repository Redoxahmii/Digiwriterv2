...
const ResourceFinder = () => {
  ...
  const handleSubmit = () => {
    ...
    setLoading(true)
    setAiResponse('')
    const prompt = `"Please ignore all previous instructions. I want you to respond only in English.
    What are the best resources for this topic and how can I utilize them properly. The topic is "${Product}".
    Please Do not echo my prompt. Do not remind me what I asked you for. Do not apologize. Do not self-reference.
    Just take the best action you can. All output must be in the English.`
          ...
          <div className="">
            <div className="form-control w-full max-w-xs gap-2">
              <label className="label">
                <span className="label-text font-semibold">Resource Finder</span>
              </label>
              <textarea name="AI Response" placeholder="Type whatever you want to learn..." className="border border-primary textarea w-full h-20 resize-none" cols="40" rows="1" onChange={(e) => setProduct(e.target.value)}></textarea>
              <label className="label">
