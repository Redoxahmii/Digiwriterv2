    ...
    <>
      <div className="drawer drawer-mobile">
            ...
            <li className="pb-2 rounded-lg">
              <div className="text-center rounded border-b-2 border-primary flex h-28 justify-center">
                <svg
                  ...
                  fill="currentColor"
                  className="w-8 h-8"
                  viewBox="0 0 408.5 406.2"
                  xmlSpace="preserve"
                >
                  <g>
                    <path
                      fill=""
                      d="M163.5,74.6c0-22.2,18.1-40.3,40.3-40.3c22.2,0,40.3,18.1,40.3,40.3V79L266,64.6l0-1.2c-5.4-30.1-31.6-51.9-62.2-51.9
		c-34.8,0-63.1,28.3-63.1,63.1v109.2l22.8,15.1L163.5,74.6L163.5,74.6z"
                    />
                    <path
                      fill=""
                      d="M243.1,331.6c0,22.2-18.1,40.3-40.3,40.3c-22.2,0-40.3-18.1-40.3-40.3v-4.5l-22,14.6l0.2,1.1c5.4,30.1,31.6,51.9,62.2,51.9
		c34.8,0,63.1-28.3,63.1-63.1V222.5l-22.8-15.1L243.1,331.6L243.1,331.6z"
                    />
                    <path
                      fill=""
                      d="M281.8,83.5l-93.8,55.8l-1.3,27.3l106.8-63.5c19.1-11.4,43.9-5.1,55.2,14c11.4,19.1,5.1,43.9-14,55.2l-3.8,2.3l23.5,11.4
		l0.7-0.4l0.4-0.2c23.1-20,28.5-53.7,12.9-80c-8.6-14.5-22.4-24.7-38.7-28.9C313.2,72.5,296.2,74.9,281.8,83.5z"
                    />
                    <path
                      fill=""
                      d="M218.7,266.8l1.3-27.3L113.2,303c-9.2,5.5-20.1,7.1-30.5,4.4c-10.4-2.7-19.2-9.2-24.7-18.4c-11.4-19.1-5.1-43.9,14-55.2
		...
		c11.2,0,22.3-3,32.1-8.9L218.7,266.8z"
                    ...
                    <path
                      fill=""
                      d="M345.9,213.2l-94.5-54.6l-24.5,12.2L334.5,233c9.3,5.4,16,14.1,18.7,24.5s1.4,21.3-4,30.6s-14.1,16-24.5,18.7
		...
		C386.4,269.3,376.1,230.6,345.9,213.2z"
                    ...
                    <path
                      fill=""
                      d="M60.7,193l94.5,54.6l24.5-12.2L72.1,173.2c-19.2-11.1-25.8-35.8-14.7-55c11.1-19.2,35.8-25.8,55.1-14.7l3.9,2.2l-1.6-26.2
