...
const ContentRewriter = () => {
    ...
    const handleSubmit = () => {
        ...
        setLoading(true)
        setAiResponse('')
        const prompt = `"Your task is to rewrite the entire text in better words and make it unique with natural language.All output shall be in English. The text to rewrite it is this: 
        ${Product}"`
