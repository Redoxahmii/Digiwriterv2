...
const ProductNameGenerator = () => {
    ...
    const handleSubmit = () => {
        ...
        setLoading(true)
        setAiResponse('')
        const prompt = `"product names for a business called ${Product} that specializes in ${Context}"`
                ...
                <div className="w-full h-full flex flex-wrap ml-28 mx-10 gap-96">
                    <div className="mt-24">
                        <div className="form-control w-full max-w-xs gap-2">
                            ...
                            <input type="text" placeholder="ie. Near Sea Side" value={Context} onChange={(e) => setContext(e.target.value)} className="input input-primary  input-bordered w-full max-w-xs" />
                            <label className="label">
