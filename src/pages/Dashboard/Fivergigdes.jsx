        ...
        <div className="hero-content flex-col lg:flex-row lg:gap-96">
          <div className="">
            <div className="form-control w-full max-w-xs gap-2">
              ...
              <textarea
                name="AI Response"
                placeholder="Describe the gig that you have created..."
                className="border border-primary textarea w-full h-20 resize-none"
                cols="40"
                rows="1"
          ...
          <div className="">
            ...
            <div
              className="mockup-window border bg-primary relative"
              id="mockup-window"
            >
              {loading ? (
              ...
              <div className="flex justify-center bg-base-200 h-full">
                <textarea
                  name="AI Response"
                  className="resize-none textarea w-full h-full p-4 box-border"
                  cols="25"
                  rows="12"
                  readOnly
                  value={aiResponse}
