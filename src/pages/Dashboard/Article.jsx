        ...
        <div className="hero-content flex-col lg:flex-row lg:gap-96">
          <div className="">
            <div className="form-control w-full max-w-xs gap-2">
              ...
              <select
                className="select select-bordered select-primary text-gray-400 w-full max-w-xs"
                value={tone}
