  ...
  return (
    <>
      <div className=" hero-content flex-col pb-20 pt-10">
        ...
        <input className="input transition-all focus:scale-105 input-bordered" type="text" placeholder="Enter your search..." value={search} onChange={(e) => setsearch(e.target.value)} />
        <button onClick={() => handleSubmit()} className="btn btn-primary gap-2 rounded-md group">
          Search
          <svg xmlns="http:/ /www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 group-hover:stroke-black group-hover:scale-110 transition-all">
        ...
        <div className="hero-content flex-col lg:flex-wrap lg:flex-row">
          {
            images.map(image => (
              ...
              <div key={image.id} onClick={() => navigator.clipboard.writeText(image.prompt)} className="card group w-96 hover:bg-primary rounded-xl bg-base-100 shadow-xl duration-300">
                ...
                <div className="flex flex-row-reverse gap-1 mr-1 mb-1">
                  <div className="tooltip" data-tip="Copy Prompt">
                    <button className="btn btn-square rounded-xl group-hover:bg-base-100 bg-primary-focus" onClick={() => navigator.clipboard.writeText(image.prompt)}>
                  ...
                  <div className="tooltip" data-tip="Download">
                    <button className="btn btn-square rounded-xl group-hover:bg-base-100 bg-primary-focus" onClick={() => handleDownloadImage(image.src)}>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
